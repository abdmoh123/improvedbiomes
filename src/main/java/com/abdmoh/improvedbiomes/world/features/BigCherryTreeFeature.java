...
public class BigCherryTreeFeature extends AbstractTreeFeature<NoFeatureConfig> {
    ...
    public BigCherryTreeFeature(Function<Dynamic<?>, ? extends NoFeatureConfig> configFactoryIn, boolean doBlockNotifyIn) {
